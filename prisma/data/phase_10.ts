...
<h2>Monétisation</h2>
<p>Freemium avec paliers : Gratuit (50 feedbacks/mois, NPS basique), Growth à 29€/mois (feedbacks illimités, analyse IA, alertes), Scale à 79€/mois (multi-sites, rapports automatiques, intégrations Discord/CRM, API). Cible les e-commerces Shopify en priorité — ils ont le volume de clients nécessaire et sont habitués à payer pour des apps. Un plugin Shopify te donne accès à un marketplace de 2 millions de boutiques.</p>`,
    exercise: `<ol>
...
<p>Tu vas construire un mini CRM (Customer Relationship Management) avec un pipeline de vente en vue kanban et un scoring de leads par IA. Pas une copie de Salesforce — un outil léger, rapide et intelligent conçu pour les freelances, les petites agences et les solopreneurs qui trouvent ton propre CRM trop lourd et un tableur Excel trop limité.</p>

...
export const MODULE_11_VOICE_LESSONS = [
  ...
  // ─── LEÇON 2 ───
  {
    order: 2,
    module: 11,
    title: "Les outils : ElevenLabs pour la Voice AI",
    slug: "outils-elevenlabs-voice-ai",
    duration: "25 min",
    description: "ElevenLabs : la plateforme de référence pour la Voice AI. Text-to-speech de qualité, voice cloning, agents conversationnels. Comment l'utiliser et combien ça coûte.",
    content: blocks([
      { id: "2-1", type: "heading", level: 2, text: "ElevenLabs : la plateforme de référence" },
      { id: "2-2", type: "text", html: "<p>En Voice AI, tu n'as pas besoin de construire de zéro. ElevenLabs se démarque comme la plateforme la plus complète du marché : text-to-speech de qualité exceptionnelle, voice cloning, et agents conversationnels intégrés. C'est l'outil que tu vas maîtriser.</p>" },
      { id: "2-3", type: "separator", style: "dots" },

      { id: "2-4", type: "heading", level: 2, text: "ElevenLabs — Text-to-Speech et agents vocaux" },
      { id: "2-5", type: "text", html: "<p><strong>ElevenLabs</strong> est la plateforme de référence pour la Voice AI. Elle propose le meilleur moteur de voix IA du marché avec des voix d'un réalisme bluffant, des émotions, des intonations naturelles, et la possibilité de cloner une voix à partir de quelques secondes d'audio.</p><p>Depuis 2024, ElevenLabs propose aussi des agents conversationnels intégrés, ce qui en fait une solution tout-en-un pour créer des agents téléphoniques IA.</p>" },
      { id: "2-6", type: "steps", steps: [
        { title: "Points forts", description: "Qualité de voix inégalée. Voice cloning (clone la voix de ton client en quelques secondes). Support de 29 langues dont le français. API simple. Agents conversationnels intégrés." },
        { title: "Cas d'usage idéal", description: "Agents téléphoniques, voiceover pour vidéos, narration de podcasts, IVR premium, ou quand tu veux cloner la voix du dirigeant pour l'agent vocal de son entreprise." },
      ...
      { id: "2-8", type: "heading", level: 2, text: "Les capacités d'ElevenLabs en détail" },
      { id: "2-9", type: "text", html: "<p><strong>ElevenLabs</strong> excelle dans trois domaines : le text-to-speech de haute qualité, le voice cloning, et les agents conversationnels. Pour tes projets clients, tu utiliseras principalement les agents conversationnels pour créer des assistants téléphoniques, et le TTS pour les projets de voiceover et narration.</p>" },
      ...
      { id: "2-12", type: "heading", level: 2, text: "ElevenLabs Agents — Créer un agent conversationnel" },
      { id: "2-13", type: "text", html: "<p>Depuis 2024, ElevenLabs propose des <strong>agents conversationnels</strong> intégrés. Tu décris ce que ton agent doit faire, tu choisis une voix (ou tu clones celle de ton client), et tu configures les actions que l'agent peut effectuer.</p><p>C'est la solution idéale car tu combines la meilleure qualité de voix du marché avec des capacités d'agent téléphonique — le tout dans une seule plateforme.</p>" },
      { id: "2-14", type: "steps", steps: [
        { title: "Points forts", description: "Qualité vocale exceptionnelle. Voice cloning intégré. Setup simple et rapide. API disponible pour l'intégration. Support multilingue natif." },
        { title: "Cas d'usage idéal", description: "Agents téléphoniques pour tous niveaux de complexité : FAQ, prise de RDV, qualification de leads, support client." },
        { title: "Pricing", description: "Les agents conversationnels sont inclus dans les plans payants. Scale (22$/mois) suffit pour la plupart des projets clients. Pro (99$/mois) pour les gros volumes." },
      ]},

      { id: "2-15", type: "separator", style: "dots" },
      { id: "2-16", type: "heading", level: 2, text: "Récapitulatif — Les capacités d'ElevenLabs" },
      { id: "2-17", type: "comparison", headers: ["Fonctionnalité", "Description", "Plan minimum"], rows: [
        { cells: ["Text-to-Speech", "Voix ultra-réalistes dans 29 langues", "Free (10K caractères)"] },
        { cells: ["Voice Cloning", "Clone une voix en quelques secondes d'audio", "Starter (5$/mois)"] },
        { cells: ["Agents conversationnels", "Agents téléphoniques IA interactifs", "Scale (22$/mois)"] },
        { cells: ["API", "Intégration dans tes projets custom", "Starter (5$/mois)"] },
        { cells: ["Multilingue", "Support natif de 29 langues dont le français", "Tous les plans"] },
        { cells: ["Analytics", "Suivi des conversations et performances", "Scale (22$/mois)"] },
      ]},

      { id: "2-18", type: "callout", variant: "tip", html: "<strong>Ma recommandation :</strong> commence avec <strong>ElevenLabs</strong>. Tu as la meilleure qualité vocale du marché avec des agents conversationnels intégrés. C'est la plateforme utilisée par la majorité des agences Voice AI qui vendent des agents premium." },

      { id: "2-19", type: "quiz-inline", question: "Quelle plateforme choisir pour créer un agent téléphonique avec une voix de qualité premium ?", options: [
        { id: "a", text: "Un outil no-code basique" },
        { id: "b", text: "Coder tout de zéro" },
        { id: "c", text: "ElevenLabs car il combine voix premium et agents conversationnels" },
      ], correctId: "c", explanation: "ElevenLabs est la plateforme idéale : meilleure qualité vocale du marché, voice cloning, et agents conversationnels intégrés. Tu as tout dans une seule plateforme." },

      { id: "2-20", type: "checklist", title: "Ce que tu retiens", items: [
        { id: "c1", text: "ElevenLabs = meilleur moteur de voix IA du marché" },
        { id: "c2", text: "Voice cloning = personnalise la voix pour chaque client" },
        { id: "c3", text: "Agents conversationnels = agents téléphoniques intégrés" },
        { id: "c4", text: "ElevenLabs est le standard du marché pour les agents premium" },
      ]},
    ]),
    exercise: "<h3>Exercice : Crée ton compte et explore</h3><p>Crée un compte gratuit sur ElevenLabs :</p><ol><li><strong>ElevenLabs</strong> (elevenlabs.io) — Teste le text-to-speech avec une phrase en français. Compare 3 voix différentes</li><li>Explore les agents conversationnels — regarde les templates disponibles</li><li>Teste le voice cloning avec ta propre voix</li></ol><p>Note :</p><ul><li>Ton impression de l'interface (facile ? complexe ?)</li><li>Le pricing pour ton cas d'usage</li><li>Un point fort et un point faible</li></ul>",
    quiz: [
      ...
      { type: "true_false", question: "ElevenLabs propose des agents conversationnels intégrés depuis 2024.", options: JSON.stringify(["Vrai", "Faux"]), correctAnswer: "Vrai", explanation: "ElevenLabs a ajouté les agents conversationnels en 2024, ce qui en fait une plateforme tout-en-un pour la Voice AI : TTS premium + voice cloning + agents téléphoniques." },
      { type: "mcq", question: "Quel plan ElevenLabs est recommandé pour des projets clients ?", options: JSON.stringify(["Free", "Starter (5$/mois)", "Scale (22$/mois)", "Enterprise"]), correctAnswer: "Scale (22$/mois)", explanation: "Le plan Scale à 22$/mois offre 100 000 caractères et l'accès aux agents conversationnels. C'est le plan idéal pour les projets clients. Le plan Pro (99$/mois) est réservé aux gros volumes." },
      { type: "mcq", question: "Combien de langues ElevenLabs supporte-t-il nativement ?", options: JSON.stringify(["5 langues", "12 langues", "29 langues", "50 langues"]), correctAnswer: "29 langues", explanation: "ElevenLabs supporte 29 langues nativement dont le français. C'est un argument de vente fort pour les clients internationaux ou francophones." },
      { type: "true_false", question: "ElevenLabs permet de cloner une voix à partir de quelques secondes d'audio.", options: JSON.stringify(["Vrai", "Faux"]), correctAnswer: "Vrai", explanation: "Le voice cloning d'ElevenLabs est bluffant. Tu peux cloner la voix du dirigeant pour personnaliser l'agent vocal de son entreprise — un argument de vente puissant." },
    ],
  },
  ...
  // ─── LEÇON 3 ───
  {
    order: 3,
    module: 11,
    title: "Créer ton premier agent téléphonique avec ElevenLabs",
    slug: "creer-premier-agent-telephonique-vapi",
    duration: "30 min",
    description: "Setup complet d'ElevenLabs : configurer un agent conversationnel, choisir une voix, écrire le prompt système, connecter un numéro de téléphone et faire ton premier test d'appel.",
    content: blocks([
      ...
      { id: "3-3", type: "callout", variant: "info", html: "<strong>Prérequis :</strong> un compte ElevenLabs (gratuit pour commencer). Un téléphone pour tester. C'est tout." },
      { id: "3-4", type: "separator", style: "dots" },

      { id: "3-5", type: "heading", level: 2, text: "Étape 1 — Créer ton agent dans ElevenLabs" },
      { id: "3-6", type: "steps", steps: [
        { title: "Va sur le dashboard ElevenLabs", description: "Connecte-toi à elevenlabs.io. Tu arrives sur la page principale avec tes assistants." },
      ...
      { id: "3-9", type: "text", html: "<p>L'agent ElevenLabs utilise un LLM pour comprendre ce que dit l'appelant et générer une réponse. Tu dois choisir quel modèle utiliser.</p>" },
      ...
      { id: "3-19", type: "text", html: "<p><strong>La voix :</strong> dans ElevenLabs, va dans les settings de ton assistant et choisis un provider de voix. Si tu utilises ElevenLabs, tu auras accès à des voix ultra-réalistes en français. Teste plusieurs voix et choisis celle qui correspond au business de ton client (voix féminine chaleureuse pour un restaurant, voix masculine professionnelle pour un cabinet d'avocats, etc.).</p><p><strong>Le numéro :</strong> ElevenLabs te permet d'acheter un numéro de téléphone directement depuis le dashboard (via Twilio ou Vonage en backend). Tu peux aussi importer un numéro existant. Le coût est d'environ 1-2$/mois par numéro.</p>" },
      ...
      { id: "3-23", type: "checklist", title: "Vérifie que tu as tout fait", items: [
        { id: "c1", text: "Agent créé dans ElevenLabs avec un nom descriptif" },
    ...
    quiz: [
      ...
      { type: "mcq", question: "Combien coûte environ un numéro de téléphone sur ElevenLabs ?", options: JSON.stringify(["Gratuit", "1-2$/mois", "50$/mois", "200$/mois"]), correctAnswer: "1-2$/mois", explanation: "Un numéro de téléphone sur ElevenLabs coûte environ 1-2$/mois (via Twilio ou Vonage en backend). C'est un coût négligeable que tu refactures à ton client dans l'abonnement mensuel." },
      { type: "true_false", question: "Dans ElevenLabs, tu es obligé d'utiliser GPT-4 comme modèle LLM.", options: JSON.stringify(["Vrai", "Faux"]), correctAnswer: "Faux", explanation: "ElevenLabs est flexible : tu peux choisir entre GPT-4o, GPT-4o-mini, Claude, et d'autres modèles. C'est l'un des avantages de la plateforme — tu adaptes le modèle au besoin et au budget." },
    ],
  },
  ...
  // ─── LEÇON 4 ───
  {
    ...
    content: blocks([
      ...
      { id: "4-6", type: "diagram", variant: "flow", nodes: [
        { id: "n1", label: "Appel entrant", description: "Le client appelle le numéro de téléphone connecté à ElevenLabs." },
        { id: "n2", label: "Agent ElevenLabs", description: "L'agent vocal répond, discute avec le client, collecte les informations (nom, date, heure, etc.)." },
        { id: "n3", label: "Function Call", description: "ElevenLabs envoie les données collectées à un webhook via une function call." },
        { id: "n4", label: "Webhook n8n", description: "Le webhook reçoit les données et déclenche un workflow d'automatisation." },
        { id: "n5", label: "Actions automatiques", description: "Stocker en BDD, créer un RDV Google Calendar, envoyer un SMS, notifier sur Discord." },
      ]},

      { id: "4-7", type: "separator", style: "line" },
      { id: "4-8", type: "heading", level: 2, text: "Les function calls dans ElevenLabs — le pont entre vocal et automatisation" },
      { id: "4-9", type: "text", html: "<p>Les <strong>function calls</strong> (ou tools) dans ElevenLabs permettent à ton agent vocal d'exécuter des actions pendant ou après l'appel. Concrètement, tu définis une fonction avec des paramètres, et quand l'agent détecte qu'il doit l'utiliser, il envoie une requête HTTP à ton endpoint.</p><p>Par exemple, tu définis une function <code>book_appointment</code> avec les paramètres <code>name</code>, <code>date</code>, <code>time</code>, <code>phone</code>. Quand le client donne toutes ces infos, l'agent appelle automatiquement ta function, qui envoie les données à ton webhook n8n.</p>" },
      { id: "4-10", type: "steps", steps: [
        { title: "Définis ta function dans ElevenLabs", description: "Va dans les settings de ton assistant > Tools > Add Tool. Donne un nom (book_appointment), une description claire pour le LLM, et les paramètres attendus (name: string, date: string, time: string, phone: string)." },
        { title: "Configure le server URL", description: "ElevenLabs enverra les appels de function à l'URL de ton serveur. Tu peux utiliser un webhook n8n comme endpoint. Copie l'URL du webhook et colle-la dans ElevenLabs." },
        { title: "Teste le flux", description: "Appelle ton agent, donne les infos de RDV. Vérifie que le webhook reçoit bien les données. Debug si nécessaire avec les logs ElevenLabs." },
      ]},
      ...
      { id: "4-14", type: "steps", steps: [
        { title: "Node 1 : Webhook Trigger", description: "Reçoit les données du function call ElevenLabs : nom, date, heure, téléphone, et toute info supplémentaire collectée pendant l'appel." },
        ...
        { title: "Node 5 : Discord Notification", description: "Envoie un message dans le channel #rdv de l'équipe : 'Nouveau RDV pris par l'agent vocal : [nom] le [date] à [heure]'." },
      ]},

      { id: "4-15", type: "callout", variant: "tip", html: "<strong>Pro tip :</strong> ajoute un node de gestion d'erreurs dans ton workflow. Si Google Calendar est down ou si le SMS échoue, tu veux le savoir. Envoie-toi une notification d'erreur sur Discord ou par email pour pouvoir intervenir rapidement." },

      { id: "4-16", type: "separator", style: "line" },
      { id: "4-17", type: "heading", level: 2, text: "Stocker les données d'appel avec Supabase" },
      { id: "4-18", type: "text", html: "<p>Supabase est parfait pour stocker les données de tes agents vocaux. Crée une table <code>voice_calls</code> avec ces colonnes :</p><ul><li><code>id</code> — UUID, clé primaire</li><li><code>call_id</code> — ID de l'appel ElevenLabs</li><li><code>caller_phone</code> — Numéro de l'appelant</li><li><code>client_name</code> — Nom récupéré pendant l'appel</li><li><code>purpose</code> — Motif de l'appel (RDV, question, réclamation)</li><li><code>appointment_date</code> — Date du RDV si applicable</li><li><code>appointment_time</code> — Heure du RDV</li><li><code>transcript</code> — Transcription complète de l'appel</li><li><code>duration_seconds</code> — Durée de l'appel</li><li><code>status</code> — completed, transferred, failed</li><li><code>created_at</code> — Timestamp</li></ul><p>ElevenLabs fournit aussi un <strong>webhook end-of-call</strong> qui t'envoie automatiquement la transcription complète et les métadonnées de chaque appel. Configure-le pour alimenter ta table.</p>" },
      ...
      { id: "4-20", type: "quiz-inline", question: "Quel mécanisme de ElevenLabs permet de connecter l'agent vocal à des services externes ?", options: [
      ...
      ], correctId: "b", explanation: "Les function calls (tools) dans ElevenLabs permettent à l'agent d'appeler des endpoints externes pendant l'appel. C'est le pont entre le vocal et l'automatisation. Le webhook de fin d'appel est complémentaire mais ne permet pas d'action en temps réel." },

      { id: "4-21", type: "checklist", title: "Ton système vocal est complet quand...", items: [
        { id: "c1", text: "Les function calls sont configurées dans ElevenLabs avec les bons paramètres" },
        ...
        { id: "c6", text: "L'équipe est notifiée sur Discord" },
        { id: "c7", text: "La mention RGPD est présente au début de l'appel" },
      ]},
    ]),
    exercise: "<h3>Exercice : Construis le workflow post-appel</h3><p>En utilisant n8n, crée un workflow complet qui :</p><ol><li><strong>Reçoit un webhook</strong> avec ces données simulées : <code>{ name: 'Jean Dupont', date: '2025-03-15', time: '14:00', phone: '+33612345678', purpose: 'consultation' }</code></li><li><strong>Insère les données</strong> dans une table Supabase 'appointments'</li><li><strong>Crée un événement</strong> Google Calendar avec les détails du RDV</li><li><strong>Envoie une notification</strong> Discord ou email avec un résumé</li></ol><p>Teste le workflow en envoyant une requête HTTP manuelle au webhook. Vérifie que chaque étape fonctionne. Capture des screenshots du workflow fonctionnel — c'est ton portfolio pour tes futurs clients.</p>",
    quiz: [
      ...
      { type: "true_false", question: "Le webhook end-of-call de ElevenLabs fournit automatiquement la transcription complète de l'appel.", options: JSON.stringify(["Vrai", "Faux"]), correctAnswer: "Vrai", explanation: "ElevenLabs envoie un webhook de fin d'appel qui contient la transcription complète, la durée, les métadonnées et le résumé de l'appel. Tu peux le configurer pour alimenter automatiquement ta base de données." },
    ],
  },
  ...
  // ─── LEÇON 5 ───
  {
    ...
    content: blocks([
      ...
      { id: "5-15", type: "diagram", variant: "flow", nodes: [
        ...
        { id: "n5", label: "Discord : Notify", description: "Message dans #cabinet : 'Nouveau RDV : [nom] le [date] à [heure] - Motif : [motif]'" },
      ]},
      ...
      { id: "5-23", type: "comparison", headers: ["Élément", "Prix recommandé", "Justification"], rows: [
        ...
        { cells: ["Intégrations (Calendar, SMS, Supabase, Discord)", "1 000€ – 1 500€", "Workflow n8n complet avec gestion d'erreurs"] },
    ...
    quiz: [
      ...
      { type: "true_false", question: "Un agent vocal pour un cabinet médical peut coûter 2 500€ – 3 500€ en setup.", options: JSON.stringify(["Vrai", "Faux"]), correctAnswer: "Vrai", explanation: "Le setup complet (agent vocal + intégrations Calendar/SMS/Supabase/Discord + tests) se facture entre 2 500€ et 3 500€. C'est justifié par la valeur apportée : le cabinet économise le coût d'une secrétaire supplémentaire dès le premier mois." },

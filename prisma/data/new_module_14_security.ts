...
export const MODULE_14_SECURITY_LESSONS = [
  ...
  // ─── LEÇON 4 : Gestion des secrets et variables d'env ───
  {
    ...
    content: blocks([
      ...
      { id: "4-15", type: "callout", variant: "tip", html: "<strong>Astuce :</strong> Utilise l'outil <code>dotenv-vault</code> ou les <strong>GitHub Secrets</strong> pour gérer tes variables d'environnement en équipe sans jamais les partager en clair par Discord ou email." },
    ]),
    ...
    quiz: [
      ...
      { type: "true_false", question: "Il est acceptable de partager des clés API par Discord ou email entre membres d'une équipe.", options: JSON.stringify(["Vrai", "Faux"]), correctAnswer: "Faux", explanation: "Ne partage jamais de secrets en clair par Discord ou email. Utilise des outils comme dotenv-vault, GitHub Secrets, ou les variables d'environnement Vercel pour les partager de manière sécurisée." },
  ...
  // ─── LEÇON 6 : Checklist sécurité avant production ───
  {
    ...
    content: blocks([
      ...
      { id: "6-13", type: "checklist", title: "Sécurité pré-production", items: [
        ...
        { id: "c10", text: "Logs d'erreurs configures (Vercel Logs + error boundary)" },
      ]},

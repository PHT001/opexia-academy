  ...
  // ─── LEÇON 5 ───
  {
    ...
    content: blocks([
      ...
      { id: "5-3", type: "steps", steps: [
        ...
        { title: "2. Automatisations de process", description: "Automatiser les tâches répétitives : tri d'emails, extraction de données, relances clients, génération de rapports. Tu connectes n8n avec une IA et tu fais gagner 10h/semaine au client." },

  ...
  // ─── LEÇON 2 ───
  {
    ...
    content: blocks([
      ...
      { id: "2-6", type: "comparison", headers: ["Couche", "Outil recommandé", "Alternative", "Pourquoi"], rows: [
        ...
        { cells: ["IA", "API OpenAI (GPT-4o)", "Anthropic Claude, Mistral", "Le plus documenté, le plus flexible, le plus fiable"] },
  ...
  // ─── LEÇON 4 ───
  {
    ...
    content: blocks([
      ...
      { id: "4-10", type: "comparison", headers: ["Type de feedback", "Méthode de collecte", "Priorité d'action", "Outil"], rows: [
        { cells: ["Bug critique", "Rapport utilisateur ou monitoring", "Immédiate (< 24h)", "Sentry, rapport email"] },
        { cells: ["Fonctionnalité manquante", "Appels utilisateurs, demandes par email", "Évaluer si aligné avec la vision", "Notion, Linear"] },

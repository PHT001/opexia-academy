...
export const MODULE_4_DESIGN_LESSONS = [
  // ─── LEÇON 1 ───
  {
    ...
    quiz: [
      ...
      { type: "true_false", question: "Un bon design nécessite d'utiliser au minimum 5 couleurs différentes pour être visuellement intéressant.", options: JSON.stringify(["Vrai", "Faux"]), correctAnswer: "Faux", explanation: "Au contraire, les meilleurs designs utilisent 2-3 couleurs maximum + des nuances de gris. Trop de couleurs = chaos visuel." },
      ...
      { type: "true_false", question: "La hiérarchie visuelle sert à guider l'œil de l'utilisateur vers les éléments importants en jouant sur la taille, le poids et la couleur.", options: JSON.stringify(["Vrai", "Faux"]), correctAnswer: "Vrai", explanation: "Exactement. La hiérarchie visuelle utilise la taille, le poids (bold), la couleur et l'espacement pour indiquer l'importance relative de chaque élément." }
    ],
  },
  ...
  // ─── LEÇON 2 ───
  {
    ...
    quiz: [
      ...
      { type: "true_false", question: "Il faut installer Figma sur son ordinateur pour pouvoir l'utiliser.", options: JSON.stringify(["Vrai", "Faux"]), correctAnswer: "Faux", explanation: "Figma fonctionne directement dans le navigateur. Il existe une app desktop, mais elle n'est pas obligatoire. Tu peux tout faire depuis figma.com." },
  ...
  // ─── LEÇON 3 ───
  {
    ...
    quiz: [
      ...
      { type: "true_false", question: "Il est recommandé de mélanger plusieurs UI kits (MUI + Bootstrap + Tailwind) dans un même projet pour avoir plus de composants.", options: JSON.stringify(["Vrai", "Faux"]), correctAnswer: "Faux", explanation: "Mélanger les UI kits crée des conflits de styles, alourdit le bundle et rend le code ingérable. Choisis un seul système et reste avec." },
  ...
  // ─── LEÇON 4 ───
  {
    ...
    quiz: [
      ...
      { type: "true_false", question: "En mobile-first avec Tailwind, le code sans préfixe de breakpoint s'applique uniquement aux mobiles.", options: JSON.stringify(["Vrai", "Faux"]), correctAnswer: "Faux", explanation: "Le code sans préfixe s'applique à TOUS les écrans (de 0px et plus). Les préfixes sm:, md:, lg: ajoutent des styles pour les écrans plus grands. C'est pour ça qu'on commence par le mobile." },
      ...
      { type: "true_false", question: "La classe max-w-prose en Tailwind limite la largeur d'un paragraphe à environ 65 caractères pour une lisibilité optimale.", options: JSON.stringify(["Vrai", "Faux"]), correctAnswer: "Vrai", explanation: "max-w-prose applique max-width: 65ch, soit environ 65 caractères. C'est la largeur idéale pour la lecture selon les études de typographie." }
    ],
  },

...
<li><strong>Agent reporting automatisé</strong> : Un agent qui génère des rapports hebdomadaires à partir de données Notion ou Google Sheets, les met en forme avec des graphiques, et les envoie par email à tes clients chaque lundi matin à 8h. Tes clients sont impressionnés par ta rigueur et pensent que tu as travaillé tout le week-end — alors que tout est automatisé.</li>

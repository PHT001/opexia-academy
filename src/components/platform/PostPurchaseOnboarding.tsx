...
const TIER_CONFIG: Record<string, TierConfig> = {
  ...
  academy: {
    ...
    description: "Tu as acces a la formation complete. 86 lecons, assistant IA, et tout ce qu'il faut pour lancer ton agence.",
    ...
    readySubtitle: "86 lecons t'attendent. Lance-toi dans le Module 1.",
  },
  one_to_one: {
    label: "One-to-One",
    tagline: "Accompagnement premium",
    description: "Bienvenue dans le programme VIP. Coaching individuel, review de projets, et acces direct a nos experts.",
    ...
    icon: "diamond",
    features: [
      "Tout le pack Academy (86 lecons)",
      "8 visios individuelles (1h)",
      "Review de projets en live",
      "Acces WhatsApp direct avec l'equipe",
      "Strategie de lancement sur-mesure",
      "Suivi hebdomadaire 3 mois",
    ],
    readyTitle: "Experience VIP activee",
    readySubtitle: "Ton premier coaching sera planifie sous 48h. En attendant, explore la formation.",
  },
};

        ...
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-2.5">
            <a
              ...
              className="inline-flex items-center justify-center gap-1.5 rounded-full px-4 py-2 text-[13px] font-semibold text-white bg-[#25D366] hover:bg-[#1EBE5A] transition-colors"
            >
          ...
          >
            <div className="flex flex-col gap-4">
              ...
              <a
                ...
                rel="noopener noreferrer"
                onClick={() => setMobileOpen(false)}
                className="inline-flex items-center justify-center gap-2 rounded-full px-6 py-3 text-sm font-semibold text-white bg-[#25D366] hover:bg-[#1EBE5A] transition-colors mt-2"
              >

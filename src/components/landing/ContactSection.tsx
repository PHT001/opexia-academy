        ...
        >
          ...
          >
            ...
            <p className="text-sm text-[#6B7280]">
              Réponse rapide, échangez directement avec notre équipe.
            </p>
        ...
        >
          {sent ? (
            <div className="text-center py-8">
              ...
              <h3 className="text-xl font-bold mb-2 text-[#111]">Message envoyé !</h3>
              <p className="text-sm text-[#6B7280]">On te répond en moins de 24h.</p>
            </div>
          ) : (
            <>
              <h3 className="text-xl font-bold text-[#111] mb-6">Envoyez-nous un message</h3>
              {error && (
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div className="grid md:grid-cols-2 gap-5">
                  <div>
                    <label className="block text-sm font-medium text-[#111] mb-1.5">Prénom</label>
                    <input
                      name="name"
                      required
                      placeholder="Votre prénom"
                      className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-[#F8F9FA] text-sm text-[#111] placeholder-[#9CA3AF] focus:outline-none focus:border-[#FF1744] focus:ring-1 focus:ring-[#FF1744] transition-all"
                    />
                  </div>
                  <div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-gray-200 bg-[#F8F9FA] text-sm text-[#111] placeholder-[#9CA3AF] resize-y focus:outline-none focus:border-[#FF1744] focus:ring-1 focus:ring-[#FF1744] transition-all"
                  />
                </div>
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full rounded-full py-3.5 text-sm font-semibold text-white bg-blue-500 hover:bg-blue-600 transition-all disabled:opacity-60"
                >

    ...
    <section id="contact" className="py-20 bg-[#F8F9FA]">
      <div className="mx-auto max-w-5xl px-6">
        ...
        <motion.div
          ...
          className="mb-8 grid gap-4 sm:grid-cols-2 max-w-2xl mx-auto"
        >
          {/* Email card */}
          <a
            href={`mailto:${EMAIL}`}
          ...
          >
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="inline-flex items-center gap-1 rounded-full bg-green-50 px-3 py-1 text-xs font-medium text-[#1DA851]">
                <svg className="h-3 w-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>

      ...
      <div className="mx-auto max-w-2xl space-y-5">
        ...
        {isFreeUser ? (
          ...
          <div className="flex flex-col items-center justify-center py-20">
            ...
            <h2 className="text-xl font-bold text-[#111] mb-2">En cours de d&eacute;veloppement</h2>
            <p className="text-sm text-gray-500 text-center max-w-sm">
              Le classement arrive bient&ocirc;t ! On peaufine les derni&egrave;res fonctionnalit&eacute;s pour te proposer la meilleure exp&eacute;rience.
            </p>
          </div>
        )}
      </div>

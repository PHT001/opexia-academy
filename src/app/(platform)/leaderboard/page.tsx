      ...
      <div className="mx-auto max-w-2xl space-y-5">
        ...
        {isFreeUser ? (
          ...
          <div className="flex flex-col items-center justify-center py-20">
            ...
            <h2 className="text-xl font-bold text-[#111] mb-2">Bient&ocirc;t disponible</h2>
            <p className="text-sm text-gray-500 text-center max-w-sm">
              Le classement sera activ&eacute; quand suffisamment d&apos;&eacute;l&egrave;ves auront rejoint la formation. Reste connect&eacute; !
            </p>
          </div>
        )}
      </div>

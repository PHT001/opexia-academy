...
const DEMO_LESSONS = [
  ...
  },
  {
    ...
    content: JSON.stringify([
      ...
      { id: "2-5", type: "heading", level: 2, text: "Les 3 modèles majeurs en 2025" },
      ...
      { id: "2-13", type: "steps", steps: [
        ...
        { title: "API Routes & Webhooks", description: "Automatisation code-based — tu connectes les outils entre eux." },

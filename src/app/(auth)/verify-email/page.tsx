    ...
    <div className="w-full max-w-md text-center">
      {success ? (
        <div>
          ...
          <h1 className="text-2xl font-bold text-[#1A1A2E] tracking-tight">Email vérifié !</h1>
        ...
        <>
          ...
          <h1 className="text-2xl font-bold text-[#1A1A2E] tracking-tight">Vérifie ton email</h1>
          ...
          <p className="text-xs text-gray-400 mt-6">
            Tu n&apos;as pas reçu le code ? Vérifie tes spams ou{" "}
            <Link href="/register" className="text-[#FF1744] hover:underline">
              réessaye l&apos;inscription
            </Link>
          </p>
        </>
      )}
